...
class NissRequestCodeServlet(Resource):
    isLeaf = True
    ...
    def render_POST(self, request: Request) -> JsonDict:
        ...
        args = get_args(request, ("niss", "client_secret", "send_attempt"))
        ...
        if not (0 < len(niss) <= MAX_EMAIL_ADDRESS_LENGTH):
            request.setResponseCode(400)
            return {"errcode": "M_INVALID_PARAM", "error": "Invalid niss provided"}
...
class NissValidateCodeServlet(Resource):
    isLeaf = True
